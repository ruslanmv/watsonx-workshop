...
An AI agent is an autonomous application that can understand, plan, and execute specific tasks using LLMs to reason and interface with tools, models, and IT systems.
...
#### Step 1: Create Knowledge Base (Python)

Create `company_kb.py`:
...
knowledge_base = KnowledgeBase(
    ...
    conversational_search_tool=ConversationalSearchConfig(
        ...
        citations=CitationsConfig(citations_shown=3)
    )
)
```

#### Step 2: Create Knowledge Base (YAML Alternative)
...
Test with: `What is the company's vacation policy?`
...
Test with: `I have a question about my last invoice and need help setting up my account`
...
### Documentation
- [watsonx Orchestrate ADK Documentation](https://ibm.github.io/watsonx-orchestrate-adk/)
- [Agent Builder Guide](https://ibm.github.io/watsonx-orchestrate-adk/agents/build_agent)
- [Tool Development](https://ibm.github.io/watsonx-orchestrate-adk/tools/create_tool)

### Community
- GitHub: [IBM watsonx Orchestrate ADK](https://github.com/IBM/ibm-watsonx-orchestrate-adk)
- Examples: [ADK Examples](https://github.com/IBM/ibm-watsonx-orchestrate-adk/tree/main/examples)

---

**Document Version:** 2.0  
**Last Updated:** October 2025  
**Workshop Duration:** 8-10 hours
